...
export const ROLES = [
  ...
  { id: 'alchemist', name: 'Alquimista', type: 'townsfolk', difficulty: -1, nightOrderFirst: 82, nightOrderOther: 82, summary: 'Escolhe alguém. Se essa pessoa morrer pelo demônio, descobre quem é o demônio.', action: 'alchemist' },
  ...
  { id: 'prince', name: 'Príncipe', type: 'townsfolk', difficulty: -2, nightOrderFirst: 86, nightOrderOther: 86, summary: 'Toda noite vê a role de alguém; depois o poder desse alvo para, exceto se for demônio.', action: 'prince' },
